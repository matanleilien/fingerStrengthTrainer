...
export function generateAssessment() {
  return {
    ...
    exercises: [
      ...
      {
        id: 'max_hang_edge',
        name: 'Max Hang — Medium Edge',
        exercise: { id: 'dead_hang', name: 'Dead Hang' },
        holdId: 5,
        holdName: 'Medium 4-Finger Edge',
      ...
      {
        id: 'max_hang_pocket',
        name: 'Max Hang — 3-Finger Pocket',
        exercise: { id: 'dead_hang', name: 'Dead Hang' },
        holdId: 7,
        holdName: 'Large 3-Finger Pocket',
      ...
      },
      {
        ...
        name: 'Repeater Test — Medium Edge',
        exercise: { id: 'repeaters', name: 'Repeaters' },
        holdId: 5,
        holdName: 'Medium 4-Finger Edge',
